  ...
  describe('loadConfigFile', () => {
    ...
    it('should throw error for invalid JSON', async () => {
      ...
      await expect(loadConfigFile('/test/dir')).rejects.toMatchObject({
        type: 'json',
        message: 'Failed to parse openui.json',
      });
    });
    ...
    it('should throw error for invalid config schema', async () => {
      ...
      await expect(loadConfigFile('/test/dir')).rejects.toMatchObject({
        type: 'validation',
        message: 'Invalid configuration in openui.json',
      });
    });
...
describe('configFileExists', () => {
  it('should return true when file exists', async () => {
    ...
    expect(fs.access).toHaveBeenCalledWith('/test/dir/openui.json');
...
describe('CONFIG_FILE_NAME', () => {
  it('should export correct config file name', async () => {
    ...
    expect(CONFIG_FILE_NAME).toBe('openui.json');
  });
});
