 ...
 *
 * This example demonstrates how to hook openui agent endpoints
...
async function main() {
  console.log(
    '🚀 Starting Express application with openui agent integration...',
  );
  ...
  try {
    ...
    // Hook openui agent endpoints into your Express app
