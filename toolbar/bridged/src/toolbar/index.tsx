  ...
  return (
    <Glassy
      ...
      className={cn(
        ...
        minimized || isInitialLoad ? 'size-10 bg-transparent' : 'size-auto',
        isDragged &&
    ...
    >
      ...
      <Button
        onClick={() => expand()}
        className={cn(
          'absolute left-0 z-50 flex size-10 origin-center cursor-pointer items-center justify-center overflow-hidden rounded-full border-none bg-transparent transition-all duration-500 ease-spring hover:scale-105',
