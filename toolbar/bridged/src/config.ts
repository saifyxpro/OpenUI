...
export interface InternalToolbarConfig {
  ...
  /**
   * If true, the toolbar will connect to a OpenUI agent hosted on the same port as the app.
   * This disables agent scanning and uses permanent reconnection logic.
   */
  usesOpenUIAgent?: boolean;

  /** Experimental features that are not yet stable and might change in the future. */
  experimental?: {
    /**
     * If true, the toolbar will use the openui MCP server.
     */
    enableOpenUIMCP: boolean;
    /**
